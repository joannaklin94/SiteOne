            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br><br>
                        @if( isset($topic->description_pol) )
                            <div class=" col-md-9 col-lg-9 ">
                        ...
                        <br><br>
                        <a class="button" href="{{ url('/prof_topics') }}"><button type="button" class="btn btn-default">Back to topics</button></a>
                    </div>
                </div>
            </div>
        </div>
